...
from lsbi.simulations import g21_lsbi, g21_mclsbi
...
#k_set = [50000]               # for compress vs non-compress
...
for k in k_set:
    ...
    theta_0, D_0, x_0,samps, samps2, d_kl = g21_mclsbi(d, n, k, N, comp=comp, theta=theta, theta_0=theta_0,
    ...
    """
    theta_0, D_0, theta, D, m, M, C, samps, samps2, d_kl = g21_lsbi(d, n, k, N, c=c, comp=comp,  theta=theta, theta_0=theta_0,
                                                       mu=mu, Sigma=Sigma,
